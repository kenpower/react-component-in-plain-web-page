    ...
    <TableHead>
      <TableRow>
              {cols.map((c) => {
                return(
                <TableCell
                  className =   {c.stickyLeft ? classes.sticky : (c.stickyRight ? classes.stickyr : "") }
                  key=          {"head" + c.id}
...
//ReactDOM.render(<EnhancedTable />, document.querySelector('#root'));

export function renderTable(r, h, id){

  rows=r;
  cols= h;
  
  ReactDOM.render(<EnhancedTable />, document.querySelector(id));
